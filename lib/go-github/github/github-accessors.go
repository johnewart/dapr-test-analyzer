...
func (a *Artifact) GetWorkflowRunMetadata() ArtifactWorkflowMetadata {
	if a == nil || a.WorkflowRunMetadata == nil {
		return ArtifactWorkflowMetadata{}
	}
	return *a.WorkflowRunMetadata
}
